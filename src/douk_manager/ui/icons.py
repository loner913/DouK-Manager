...
def _pixmap(name: str, color: str, size: int) -> QPixmap:
    ...
    if name == "sun":
        ...
        for x1, y1, x2, y2 in ((12, 2, 12, 5), (12, 19, 12, 22), (2, 12, 5, 12), (19, 12, 22, 12), (5, 5, 7, 7), (17, 17, 19, 19), (5, 19, 7, 17), (17, 7, 19, 5)):
            line(x1, y1, x2, y2)
    elif name == "moon":
        path = QPainterPath(QPointF(16, 3))
        path.cubicTo(3, 0, 0, 19, 12, 21)
        path.cubicTo(17, 22, 21, 18, 21, 15)
        path.cubicTo(12, 19, 8, 8, 16, 3)
